...
def handle_data(context, data):
    # Only rebalance at the beggining of the algorithm execution and every multiple of the rebalance period
    if context.i == 0 or context.i%context.rebalance_period == 0:
        n = context.window
        prices = data.history(context.assets, fields='price', bar_count=n+1, frequency='1d') 
        ...
        # Compute the expected returns of each asset with the average daily return for the selected time window
...
results = catalyst.run_algorithm(start=start, end=end, initialize=initialize, 
                                 ...
                                 bundle='poloniex', analyze=analyze)
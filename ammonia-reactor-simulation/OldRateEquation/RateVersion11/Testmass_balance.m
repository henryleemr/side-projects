function Func = Testmass_balance(FNH3OUT)
...
%Take the new FNH3IN as the previous FNH3OUT from DiscUpdate.m
FNH3IN = FNH3OUT;
% FNH3IN = F0;  %?? how to pass the updated FNH3IN into the function?

%Form first equation, changes in NH3 feed, kmol/hr
CHANGEFNH3 = FNH3OUT - FNH3IN;
CHANGEFN2  = -(1/2)*CHANGEFNH3;  % correct?
